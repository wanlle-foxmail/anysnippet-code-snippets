...
SQL_PATH = SNIPPET_ROOT / "src" / "paginate_rows.sql"
...
class MySQLSnippetTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.temp_dir = tempfile.TemporaryDirectory(prefix="paginate-rows-mysql-")
...
class PaginateRowsWithSqlTests(MySQLSnippetTestCase):
    def setUp(self):
        self.run_mysql(
            """
    ...
    def test_returns_the_second_page_from_a_larger_result_set(self):
        self.insert_items(
            [
    ...
    def test_uses_item_id_as_a_tie_breaker_for_matching_timestamps(self):
        self.insert_items(
            [
                (1, "alpha", "2026-04-01 08:00:00"),
                (2, "bravo", "2026-04-01 09:00:00"),
    ...
    def test_returns_a_partial_page_when_fewer_rows_remain(self):
        self.insert_items(
            [
                (1, "alpha", "2026-04-01 08:00:00"),
                (2, "bravo", "2026-04-01 09:00:00"),
    ...
    def test_returns_no_rows_when_the_offset_reaches_the_table_end(self):
        self.insert_items(
            [
                (1, "alpha", "2026-04-01 08:00:00"),
                (2, "bravo", "2026-04-01 09:00:00"),
